...
export default function AdminError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="font-display text-[28px] font-light text-text-main">Erreur administration</h1>
      ...
      <div className="mt-8 flex items-center gap-4">
        ...
        <Link href="/admin" className="inline-flex items-center gap-2 bg-primary-brand px-5 py-2.5 font-body text-xs uppercase tracking-[0.12em] text-white hover:bg-primary-dark transition-colors">
